...
d1=extrac(rfits(fnames[i-1]),1600,2200, 256, 256)

d2=extrac(rfits(fnames[i]),1600,2200, 256, 256)

d3=extrac(rfits(fnames[i+1]),1600,2200, 256, 256)
...
tvscl, d2
;plot, q.x, q.y, position=[0,0,256,256], /dev, /noe, psym=1, xrange=[0,256], yrange=[0,256], xstyle=1, ystyle=1

res=opt_fl(d1,d2,d3,q.x,q.y,3)

arrow, q.x, q.y, q.x+res.vx*50,q.y+res.vy*50, hsize=3
...
res=opt_fl(d1,d2,d3,[10,20],[10,20],5)
vect[0,*,i-1]=res.vx*8
vect[1,*,i-1]=res.vy*8
vect[2,*,i-1]=replicate(1.,2)
tvscl, d2
